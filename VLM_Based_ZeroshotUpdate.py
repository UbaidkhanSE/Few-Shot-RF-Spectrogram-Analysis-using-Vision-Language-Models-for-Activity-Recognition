...
class SpectrogramAnalyzer:
    ...
    def setup_categories(self):
        self.subject_categories = [
            "RF spectrogram exhibiting baseline noise patterns characteristic of an unoccupied space",
        ...
        self.movement_categories = [
            ...
            "RF spectrogram displaying linear Doppler signatures indicative of consistent directional movement",
